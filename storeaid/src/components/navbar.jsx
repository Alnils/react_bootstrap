    ...
    <div className ="navbarcontainer">
        <div className="topcontainer">
            ...
            <div className="socialmediaicons">
                <img src="./src/imgs/0-header/facebook_icon.svg" alt="Facebook" width="30" height="30"></img>
                <img src="./src/imgs/0-header/twitter_icon.svg" alt="Twitter" width="30" height="30"></img>
                <img src="./src/imgs/0-header/instagram_icon.svg" alt="Instagram" width="30" height="30"></img>
                <img src="./src/imgs/0-header/youtube_icon.svg" alt="YouTube" width="30" height="30"></img>
            </div>
        </div>
